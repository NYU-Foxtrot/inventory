...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "inventory" do |inventory|
      ...
      inventory.vm.network "forwarded_port", guest: 5000, host: 5000, host_ip: "127.0.0.1"
      ...
      inventory.vm.synced_folder "./", "/vagrant", owner: "ubuntu", mount_options: ["dmode=755,fmode=644"]
